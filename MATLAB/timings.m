function timings = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   TIMINGS8THREADS = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   TIMINGS8THREADS = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data
%   from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   timings8threads = importfile('timings_8_threads.txt', 2, 12);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/03/17 14:07:35
